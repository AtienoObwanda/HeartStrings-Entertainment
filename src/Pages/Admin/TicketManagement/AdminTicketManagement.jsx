        ...
        <div className="bg-black_900_01 flex flex-col font-roboto items-center justify-start mx-auto w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
            <aside className="bg-black_900 flex flex-col md:hidden justify-start md:px-5 w-[247px]">
              ...
              <div className="flex flex-col gap-4 items-start justify-start mt-4 mx-auto self-stretch w-auto">
                <div className="bg-gray_800 flex flex-row gap-2 items-center justify-center pl-6 md:pr-10 pr-[91px] sm:px-5 py-2.5 rounded-lg self-stretch w-auto">
                  <Img
                ...
                <div
                  className="common-pointer flex flex-row gap-2 items-center justify-center sm:pl-5 pl-6 pr-3 py-2.5 self-stretch w-auto"
