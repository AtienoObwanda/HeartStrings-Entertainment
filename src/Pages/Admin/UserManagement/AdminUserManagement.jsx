...
<div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full md:mt-[-30em] sm:mt-[-30em]">
            ...
            <div className="md:h-[1305px] sm:h-[600px] h-[850px] relative w-[92%] md:w-full">
                <div className="font-roboto h-full md:h-[394px] sm:h-[112px] mt-[23px] relative w-full">
                  ...
                  <div className="sm:hidden flex flex-row md:gap-10 items-center justify-between w-[96%] md:w-full mb-4">
                    <Text
                      className="font-bold text-left text-white_A700 w-auto ml-4"
                      as="h6"
                      variant="h6"
                    >
                      Users
                  ...
                  <UserManagement/>
                    <Text
                      ...
                      variant="h6"
                    >
                      Use your Desktop or Tablet to Manage Users
                    </Text>
                    </div>
                    </div>
                    </div>
