    ...
    <>
      <div className="bg-black_900 flex flex-col font-roboto sm:gap-10 md:gap-10  gap-24 items-center justify-start mx-auto w-full">
        <Navbar
          ...
          account="Account"
        />
        <div className="bg-black_900_01 border border-gray_300 border-solid flex flex-col items-center justify-center px-40 md:px-5 py-12 rounded-lg self-stretch mb-[4em] md:mb-[21em] sm:mb-[16em] mt-[4em] md:mt-[21em] sm:mt-[16em] md:w-3/4 mx-auto">
        {/* <div className="bg-black_900_01 border border-gray_300 border-solid flex flex-col items-center justify-center px-40 md:px-5 py-12 rounded-lg self-stretch md:w-full"> */}
