        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <aside className="flex flex-col md:hidden justify-start md:px-5 w-[247px]">
            <div className="flex flex-col items-start justify-start mb-[420px] ml-6 mr-4 mt-12 w-[84%]">
              ...
              <div
                className="common-pointer flex flex-row gap-2 items-center justify-start mt-4 pl-6 md:pr-10 pr-[73px] sm:px-5 py-2.5 w-[199px]"
              ...
              <div className="bg-gray_800 flex flex-row gap-2 items-center justify-center mt-4 pl-6 md:pr-10 pr-[83px] sm:px-5 py-2.5 rounded-lg self-stretch w-auto">
                <Img
